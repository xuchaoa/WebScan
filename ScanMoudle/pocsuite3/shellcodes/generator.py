...
class ShellGenerator:
    ...
    def check_for_system_utils(self):
        """Checks ScanMoudle. If any util is not exists precompiled shellcodes will be used"""
        import platform
    ...
    def get_shellcode(self, shellcode_type, connectback_ip="127.0.0.1", connectback_port=5555, make_exe=0, debug=0,
        ...
        if self.use_precompiled:
            logger.info('Some ScanMoudle needed for shellcode compilation are not found. Only precompiled shellcodes can be used.')
